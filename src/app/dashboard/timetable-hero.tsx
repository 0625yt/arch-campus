              ...
              return daySlots.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`spring-press group absolute flex flex-col items-start justify-start overflow-hidden rounded-[7px] px-1.5 py-1 text-left transition-all hover:brightness-95 ${
                      isNow ? "now-glow" : ""
                    }`}
                    style={{
                      top: `calc(${top}% + 2px)`,
                  ...
                  >
                    ...
                    />
                    <span
                      className="ml-1 line-clamp-1 text-[11px] leading-[1.18] wght-620 text-[var(--color-apple-ink)]"
                      style={{ letterSpacing: "-0.012em" }}
                    >
                      {s.courseName}
                    </span>
                    {height > 7 && (
                      <span
                        className="ml-1 mt-0.5 line-clamp-1 text-[9.5px] wght-450 tabular-nums text-[var(--color-apple-ink)]/60"
                        style={{ letterSpacing: "-0.012em" }}
                      >
