              ...
              {monthCells.map((cell, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Events — 모든 viewport에서 동일한 옅은 칠 막대 (한컴 캘린더 스타일) */}
                    {cellEvents.length > 0 && (
                      <div className="mt-1 flex flex-col items-center gap-[2px] px-px sm:gap-[3px]">
                        {cellEvents.slice(0, 3).map((event) => (
                          <button
                            ...
                            className="flex h-[15px] w-full items-center justify-center overflow-hidden rounded-[3px] px-[3px] text-center text-[9px] leading-none wght-620 text-[var(--color-apple-ink)] sm:h-[18px] sm:rounded-[4px] sm:px-1.5 sm:text-[11px]"
                        ...
                        {cellEvents.length > 3 && (
                          <span
                            className="text-[9px] wght-560 leading-none text-[var(--color-apple-muted)] sm:text-[10.5px]"
                            aria-hidden
                          >
                            +{cellEvents.length - 3}
                          </span>
