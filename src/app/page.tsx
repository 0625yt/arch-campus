...
const FLOW = [
  {
    step: "01",
    title: "자료를 넣으면",
    body: "강의자료, 강의계획서, 시간표를 종류별로 받아요.",
  },
  {
    step: "02",
    title: "해야 할 일이 보이고",
    body: "시험, 과제, 발표, 복습이 오늘 기준으로 정리돼요.",
  },
  {
    step: "03",
    title: "공부로 이어져요",
    body: "요약, 문제, 오답, 과제 체크가 한 흐름으로 연결돼요.",
  },
] as const;
...
const FEATURES = [
  {
    title: "오늘 해야 할 일만",
    body: "마감과 복습을 한꺼번에 보여주지 않고 지금 바로 처리할 것부터 보여줘요.",
    label: "Today",
  },
  {
    title: "자료에서 일정 만들기",
    body: "강의계획서와 공지에서 날짜 후보를 뽑고, 확인한 뒤 캘린더에 넣어요.",
    label: "Calendar",
  },
  {
    title: "과목별 공부 히스토리",
    body: "운영체제, 자료구조처럼 과목을 눌러 자료, 요약, 문제 기록을 이어서 봐요.",
    label: "Study",
  },
  {
    title: "과제 제출 조건 체크",
    body: "파일명, 제출 형식, 감점 포인트처럼 놓치면 손해보는 조건을 먼저 잡아요.",
    label: "Tools",
  },
] as const;
