...
7. **교수 이름을 강의명으로 만들지 마라.** 셀 안에 "김병국"처럼 사람 이름만 남으면 그건 강의가 아니라 다른 셀의 교수명이 잘못 들어온 것. 추출 X. (한국 이름은 보통 2~4자 한글, 강의명은 더 길거나 영어/숫자가 섞인다.)
8. **연속 교시 시간 합치기 — 분 단위까지.** 한 강의가 같은 요일에 5교시(13:00~13:50)와 6교시(14:00~14:50)에 걸쳐있으면 시간은 13:00~14:50, 슬롯 1개. 13:00~13:50과 14:00~14:50으로 슬롯 2개로 만들지 말 것. 점심 시간이 끼더라도 같은 셀이면 합친다.
