...
> **2026-09-17 감사 메모:** 이 문서는 과거 모델 조사·선택 이력을 보존한다. 현재 사용 모델과 검증 수준은 [STATUS.md](STATUS.md), 최신 공식 자료의 적용 판단은 [점검 보고서](audit/2026-09-17-feature-audit.md)를 따른다. 모델명·가격·벤치마크의 현재 유효성을 이 기록만으로 보장하지 않는다.
